...
import com.prueba.bean.TasaDeCambioController;
...
public class TasaDeCambioControllerConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        TasaDeCambioController controller = (TasaDeCambioController) facesContext.getApplication().getELResolver().
                getValue(facesContext.getELContext(), null, "tasacambioController");
